...
/**
 * iOS [SearchPreferencesRepository] (PR #41), the counterpart of desktop's
 * [DesktopSearchPreferencesRepository]. Backed by an [IosJsonStore] — the same two
 ...
 * [DefaultSiteResolver.merge] so user overrides win). The reactive `flow()` is a
 * [MutableStateFlow] re-emitted after each mutation.
 */
class IosSearchPreferencesRepository(
